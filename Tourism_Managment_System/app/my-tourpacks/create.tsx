...
import { tourpacksRoute } from '../../src/routes/tourpacks';
    ...
    try {
      ...
      if (data.success) {
        Alert.alert('Success! 🎉', 'Tour package created!', [
          { text: 'View All', onPress: () => router.replace(tourpacksRoute) },
        ]);
      } else {
...
const styles = StyleSheet.create({
  ...
  headerSub: { color: 'rgba(255,255,255,0.6)', fontSize: 11, letterSpacing: 3, marginBottom: 4 },
  headerTitle: { color: '#fff', fontSize: 30, fontWeight: '800' },
  headerDesc: { color: 'rgba(255,255,255,0.7)', fontSize: 13, marginTop: 4 },
  ...
  submitBtn: {
    backgroundColor: '#003580', borderRadius: 30,
    height: 58, justifyContent: 'center', alignItems: 'center',
    marginTop: 8,
    shadowColor: '#003580', shadowOffset: { width: 0, height: 6 },
